...
SELECT department.name AS department, suppliers.organization_name AS suppliers, clients.organization_name AS clients, staff.first_name AS first_name, staff.last_name AS last_name
FROM department
LEFT JOIN suppliers
...
WHERE staff.date_of_dismissal IS NULL
ORDER BY department;
